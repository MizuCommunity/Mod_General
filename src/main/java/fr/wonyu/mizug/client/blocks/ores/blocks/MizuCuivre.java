...
public class MizuCuivre extends Block implements IHasModel {

	public static final String CUIVRE = "cuivre_block";

	public MizuCuivre(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, CUIVRE);
		setResistance(5.0F);
		setHardness(2.0F);
