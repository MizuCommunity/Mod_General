...
public class MizuEtain extends Block implements IHasModel {

	public static final String ETAIN = "etain_block";

	public MizuEtain(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, ETAIN);
		setResistance(5.0F);
		setHardness(2.0F);
