...
public class MizuBoutXL extends BlockHorizontal implements IHasModel{

	public static final String BOUT_XL = "bouteille_xl";

	public MizuBoutXL(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, BOUT_XL);
		setResistance(5.0F);
		setHardness(3.0F);
