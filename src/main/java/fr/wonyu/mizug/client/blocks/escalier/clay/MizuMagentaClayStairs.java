...
public class MizuMagentaClayStairs extends BlockStairs implements IHasModel {
	
	public static final String CLAY_MAGENTA = "stair_clay_magenta";

	public MizuMagentaClayStairs(Material mat, IBlockState state) {
		super(state);
		MizuBlocks.setBlockName(this, CLAY_MAGENTA);
