...
public class MizuCuivreOre extends Block implements IHasModel{

	public static final String CUIVRE_ORE = "cuivre_ore";
	Random rand;

	public MizuCuivreOre(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, CUIVRE_ORE);
		setResistance(5.0F);
		setHardness(2.5F);
