...
public class MizuBucheChaiseOak extends BlockHorizontal implements IHasModel {

	public static final String BUCHE_SIT_OAK = "oak_wooded";
	
    public static final AxisAlignedBB BUCHE_SIT = new AxisAlignedBB(1.6 * 0.0625, 12 * 0.0625, 1.6 * 0.0625, 14.4 * 0.0625, 9.6 * 0.0625, 14.4 * 0.0625);
    public static final AxisAlignedBB BUCHE_COL_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, -0.3, 0.0, -1.0, 1.4, 1.1, 2.0);
    public static final AxisAlignedBB BUCHE_COL_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, -0.3, 0.0, -1.0, 1.4, 1.1, 2.0);
    public static final AxisAlignedBB BUCHE_COL_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, -0.3, 0.0, -1.0, 1.4, 1.1, 2.0);
    public static final AxisAlignedBB BUCHE_COL_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, -0.3, 0.0, -1.0, 1.4, 1.1, 2.0);
	...
	public MizuBucheChaiseOak(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, BUCHE_SIT_OAK);
		setResistance(5.0F);
		setHardness(3.0F);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            if(MizuSit.sitOnBlock(worldIn, pos.getX(), pos.getY(), pos.getZ(), playerIn, 7 * 0.0825))
            {
    ...
    private List<AxisAlignedBB> getCollisionBoxList(IBlockState state)
    {
        ...
        {
            case NORTH:
                list.add(BUCHE_COL_NORTH);
                break;
            case SOUTH:
                list.add(BUCHE_COL_SOUTH);
                break;
            case WEST:
                list.add(BUCHE_COL_WEST);
                break;
            default:
                list.add(BUCHE_COL_EAST);
                break;
        }
        list.add(BUCHE_SIT);
