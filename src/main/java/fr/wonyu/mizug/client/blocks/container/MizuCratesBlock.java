...
public class MizuCratesBlock extends BlockContainer implements IHasModel {

	public static final String CRATES = "crates_block";

	public MizuCratesBlock(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, CRATES);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new MizuTileCratesBlock();
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(MizuG.instance, MizuGuiHandler.cratesGuiID, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
