...
public class MizuGreenClayStairs extends BlockStairs implements IHasModel {
	
	public static final String CLAY_GREEN = "stair_clay_green";

	public MizuGreenClayStairs(Material mat, IBlockState state) {
		super(state);
		MizuBlocks.setBlockName(this, CLAY_GREEN);
