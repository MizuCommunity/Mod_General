...
public class MizuBoutChoppXXL extends BlockHorizontal implements IHasModel{

	public static final String BOUT_CHOPP_XXL = "bouteille_choppe_xxl";

	public MizuBoutChoppXXL(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, BOUT_CHOPP_XXL);
		setResistance(5.0F);
		setHardness(3.0F);
