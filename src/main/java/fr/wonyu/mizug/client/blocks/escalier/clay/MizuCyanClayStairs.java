...
public class MizuCyanClayStairs extends BlockStairs implements IHasModel {
	
	public static final String CLAY_CYAN = "stair_clay_cyan";

	public MizuCyanClayStairs(Material mat, IBlockState state) {
		super(state);
		MizuBlocks.setBlockName(this, CLAY_CYAN);
