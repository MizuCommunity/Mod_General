...
public class MizuLimeClayStairs extends BlockStairs implements IHasModel {
	
	public static final String CLAY_LIME = "stair_clay_lime";

	public MizuLimeClayStairs(Material mat, IBlockState state) {
		super(state);
		MizuBlocks.setBlockName(this, CLAY_LIME);
