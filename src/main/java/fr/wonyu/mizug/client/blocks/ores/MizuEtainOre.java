...
public class MizuEtainOre extends Block implements IHasModel{

	public static final String ETAIN_ORE = "etain_ore";
	Random rand;

	public MizuEtainOre(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, ETAIN_ORE);
		setResistance(5.0F);
		setHardness(2.0F);
