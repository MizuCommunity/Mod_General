...
public class MizuPorte extends BlockHorizontal implements IHasModel {
	public static final String PORTE = "armoire_portes";
	public static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0, 0.0, 0.0, 1.0, 2.0, 1.0);

	public MizuPorte(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, PORTE);
		setResistance(5.0F);
		setHardness(3.0F);
