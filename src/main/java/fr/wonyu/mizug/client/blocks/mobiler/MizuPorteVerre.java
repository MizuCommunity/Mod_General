...
public class MizuPorteVerre extends BlockHorizontal implements IHasModel {

	public static final String ARMOIRE_VERRE_P = "armoire_porte_verre";
	public static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0, 0.0, 0.0, 1.0, 2.0, 1.0);

	public MizuPorteVerre(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, ARMOIRE_VERRE_P);
		setResistance(5.0F);
		setHardness(3.0F);
