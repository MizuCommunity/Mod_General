...
public class MizuAmetysteOre extends Block implements IHasModel {

	public static final String AMETYSTE_ORE = "ametyste_ore";
	Random rand;

	public MizuAmetysteOre(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, AMETYSTE_ORE);
		setResistance(5.0F);
		setHardness(3.0F);
