...
public class MizuUranium extends Block implements IHasModel {

	public static final String URANIUM = "uranium_block";
	Random rand;

	public MizuUranium(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, URANIUM);
		setResistance(5.0F);
		setHardness(4.0F);
	...
	public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
		...
		if (true)
			for (int l = 0; l < 4; ++l) {
				...
				par1World.spawnParticle(EnumParticleTypes.REDSTONE, d0, d1, d2, d3, d4, d5, 1, 0, 1);
			}
	}
