...
public class MizuRedClayStairs extends BlockStairs implements IHasModel {
	
	public static final String CLAY_RED = "stair_clay_red";

	public MizuRedClayStairs(Material mat, IBlockState state) {
		super(state);
		MizuBlocks.setBlockName(this, CLAY_RED);
