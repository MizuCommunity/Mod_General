...
public class MizuArgentOre extends Block implements IHasModel{

	public static final String ARGENT_ORE = "argent_ore";
	Random rand;

	public MizuArgentOre(Material mat) {
		super(mat);
		MizuBlocks.setBlockName(this, ARGENT_ORE);
		setResistance(5.0F);
		setHardness(2.5F);
