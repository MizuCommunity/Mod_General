...
public class MizuTileCratesBlock extends TileEntity implements IInventory {
	private final int NUMBER_OF_SLOTS = 18;
	private ItemStack[] itemStacks;

	public MizuTileCratesBlock()
	{
	...
	public boolean isEmpty()
  {
	...
	public String getName() {
		return "container.mizucrates.name";
	}
