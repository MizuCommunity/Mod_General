...
public class MizuSitEntity extends Entity
{
    public int blockPosX;
    public int blockPosY;
    public int blockPosZ;

    public MizuSitEntity(World world)
    {
        super(world);
        this.noClip = true;
        this.height = 0.01F;
    ...
    public MizuSitEntity(World world, double x, double y, double z, double y0ffset)
    {
        this(world);
    ...
    public MizuSitEntity(World world, double x, double y, double z, double y0ffset, int rotation, double rotationOffset)
    {
        this(world);
        this.blockPosX = (int) x;
        this.blockPosY = (int) y;
