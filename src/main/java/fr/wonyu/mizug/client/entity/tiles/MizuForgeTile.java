...
import fr.wonyu.mizug.client.recipe.MizuForgeRecipeList;
...
public class MizuForgeTile extends TileEntity implements IInventory, ITickable {
	...
	public static ItemStack getSmeltingResultForItem(ItemStack stack) { return MizuForgeRecipeList.instance().getSmeltingResult(stack); }
 ...
 */
  ...
  //------------------------
	...
	public String getName() {
		return "container.mizu_furnace.name";
	}
