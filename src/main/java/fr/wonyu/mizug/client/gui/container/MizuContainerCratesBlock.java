...
public class MizuContainerCratesBlock extends Container {
	...
	private final int TE_INVENTORY_ROW_COUNT = 2;
	...
	public MizuContainerCratesBlock(InventoryPlayer invPlayer, MizuTileCratesBlock tileEntityInventoryBasic) {
		this.tileEntityInventoryBasic = tileEntityInventoryBasic;

		final int SLOT_X_SPACING = 18;
		final int SLOT_Y_SPACING = 18;
		final int HOTBAR_XPOS = 8;
		final int HOTBAR_YPOS = 126;
		...
		final int PLAYER_INVENTORY_YPOS = 68;
