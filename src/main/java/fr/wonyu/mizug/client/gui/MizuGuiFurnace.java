...
public class MizuGuiFurnace extends GuiContainer {

	// This is the resource location for the background image
	private static final ResourceLocation texture = new ResourceLocation(References.MODID, "textures/gui/mizu_furnace.png");
	private MizuForgeTile tileEntity;

	public MizuGuiFurnace(InventoryPlayer invPlayer, MizuForgeTile tileInventoryFurnace) {
		super(new MizuContainerForge(invPlayer, tileInventoryFurnace));
