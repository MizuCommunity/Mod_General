package fr.wonyu.mizug.api.inventory;
 ...
 */
public class MizuStacksBase implements IItemHandler, IItemHandlerModifiable, INBTSerializable<NBTTagCompound>
{

    protected NonNullList<ItemStack> stacks;
    protected boolean[] isSkinArmor;

    public MizuStacksBase()
    {
        this(4);
    }

    public MizuStacksBase(int size)
    {
        setSize(size);
    }
